...
from models.equiformer.graph_attention_transformer import graph_attention_transformer_l2_multi
...
def train():
    ...
    model_dir = 'equiformer_multimodal'
    k_folds = 3
    batch_size = 64
    learning_rate = 1e-3
    epochs = 35
    ...
    for target_index, target_name in zip(target_indices, target_names):
        ...
        for fold, (train_idx, test_idx) in enumerate(kf.split(dataset)):
            ...
            model = graph_attention_transformer_l2_multi(
            ).to(device)
            ...
            for epoch in range(1, epochs + 1):
                ...
                for data in train_loader:
                    ...
                    target_pred = model(data.z, data.pos, data.batch, data.z, clip_embeddings=data.clip_embedding)
