...
from models.faenet.model import FAENetMulti
        ...
        for fold, (train_idx, test_idx) in enumerate(kf.split(dataset)):
            ...
            for epoch in range(1, epochs + 1):
                ...
                for data in train_loader:
                    ...
                    # Forward pass
                    target_pred = model(data, clip_embeddings=data.clip_embedding)
